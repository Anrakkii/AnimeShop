...
if(isset($_SESSION['sign_in'])){
    ...
    $profile_query = "SELECT * FROM tbl_customer WHERE customer_id = '$customer_id' ";
    $profile_query_link = mysqli_query($con,$profile_query);
    $profile_result = $profile_query_link->fetch_array();
    if(isset($_GET['edit']) and $_GET['edit']==1){
        if(isset($_POST['edit_confirm'])){
            ...
            if($alert==null){
                ...
                customer_address = '$customer_address', customer_password = '$customer_password',
                ...
                if($sql_sign_up){
                    ...
                    $_SESSION['sign_up'] = $customer_id;
                    $_SESSION['sign_in'] = $customer_id;
...
?>
            <form action="" method="POST">
                <table class="edit">
                    <tr>
                        <td>Họ và tên</td>
                        <td><input type="text" size="50" name="name" value="<?php echo $profile_result['customer_name'] ?>"></td>
                    </tr>
                    <tr>
                        <td>Email</td>
                        <td><input type="text" size="50" name="email" value="<?php echo $profile_result['customer_email'] ?>"></td>
                    </tr>
                    <tr>
                        <td>Điện thoại</td>
                        <td><input type="text" size="50" name="phone" value="<?php echo $profile_result['customer_phone'] ?>"></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>Mật khẩu</td>
                        <td><input type="password" size="50" name="password" value="<?php echo $profile_result['customer_password'] ?>" ></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><input type="submit" name="edit_confirm" value="Xác nhận chỉnh sửa"></td>
                        <td>Hãy đảm bảo thông tin chính xác trước khi xác nhận!</td>
                    </tr>
                    <tr>
                        <td style="color:red">
                        <?php 
    ...
    <table class="edit">
        <tr>
            <td>Họ và tên</td>
            <td><input readonly type="text" size="50" placeholder="<?php echo $profile_result['customer_name'] ?>"></td>
        </tr>
        <tr>
            <td>Email</td>
            <td><input readonly type="text" size="50" placeholder="<?php echo $profile_result['customer_email'] ?>"></td>
        </tr>
        <tr>
            <td>Điện thoại</td>
            <td><input readonly type="text" size="50"placeholder="<?php echo $profile_result['customer_phone'] ?>"></td>
        </tr>
        <tr>
            <td>Địa chỉ</td>
            <td><input readonly type="text" size="50" placeholder="<?php echo $profile_result['customer_address'] ?>"></td>
        </tr>
        <tr>
            <td>Mật khẩu</td>
            <td><input readonly type="password" size="50" value="<?php echo $profile_result['customer_password'] ?>"></td>
        </tr>
        <tr>
            <td>Chỉnh sửa</td>
            <td><a style="color:blue" href="profile.php?edit=1">Chỉnh sửa thông tin tài khoản</a></td>
        </tr>
    </table>
    <?php } ?>
<?php
